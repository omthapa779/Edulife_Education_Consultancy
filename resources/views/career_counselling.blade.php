...
<html>
  <head>
    <title>EduLife Education Consultancy | Career Counselling</title>
    <meta charset="utf-8">
    ...
    <div id="bodywrap" class="overflow-hidden">
      ...
      <section id="intro2">
        <div class="image-holder position-relative">
          <img src="images/banner-item6.jpg" alt="banner" class="banner-image">
        </div>
        <div class="container-lg">
          <div class="banner-content position-absolute" style="align-items: center;" data-aos="fade-up" >
            <h1 class="banner-title light text-uppercase fw-bold" style="text-align: center;">Career Counselling</h1>
            <div class="col-lg-12" style="text-align: center;">
              <p>
              EduLife's expert counselors provide essential career guidance, 
              helping students make informed decisions by offering insights into courses, 
              programs, and institutions. Committed to unraveling individual potential, 
              we collaborate closely with university faculty to ensure students choose courses 
              aligned with their profiles, empowering them for a successful future.<br>
